<x-app-layout>
    <div class="py-7 sm:py-10">
        <div class="mx-auto max-w-5xl space-y-6 px-4 sm:px-6 lg:px-8">
            <header>
                <p class="eyebrow">Import en un clic</p>
                ...
                <p class="mt-3 max-w-2xl text-base leading-7 text-gray-600 dark:text-gray-300">
                    Récupère les informations de la page que tu consultes, vérifie-les, puis envoie l’événement dans FeedEvent comme brouillon.
                </p>
            </header>
